            ...
            <div className="navbar flex items-center bg-black text-slate-200 p-3 rounded-b-lg top-0 mb-12 lg:mb-4">
                ...
                <div className="navbar-end">
                    ...
                    {user?.email ? <>
                        ...
                        <Link to='/login'><button className="btn btn-sm me-1 md:btn-md btn-outline hover:bg-white hover:text-black text-slate-200 btn-neutral">Login</button></Link>
                    }
                    <label className="swap swap-rotate ms-1">
